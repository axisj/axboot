...
export class ExampleRepositoryMock extends ExampleRepositoryInterface {
  async list(params: ExampleListRequest): Promise<ExampleListResponse> {
    console.log("Example list", params);
    await delay(300);
    return {
      ds: resDs,
      page: {
  ...
  async save(params: ExampleSaveRequest): Promise<ExampleSaveResponse> {
    console.log("Example save", params);
    await delay(300);
    return {
      rs: {
  ...
  async detail(params) {
    console.log("Example detail", params);
    await delay(300);
    return {
      rs: {
        updatedAt: "2022-09-27T18:19:29",
  ...
  async childList(params): Promise<ExampleChildListResponse> {
    console.log("Example childList", params);
    await delay(300);
    return {
      ds: [
        {
  ...
  async childListSave(params: ExampleChildSaveRequest): Promise<ExampleChildSaveResponse> {
    console.log("Example childListSave", params);
    await delay(300);
    return {};
  }

  async stat(params: ExampleStatRequest): Promise<ExampleStatResponse> {
    console.log("Example stat", params);
    await delay(300);
  ...
  async getTodo(params: GetTodoRequest): Promise<GetTodoResponse> {
    console.log("Example getTodo", params);
    await delay(300);
    return {
      ds: [
        {
          ...
          date: `${params.baseMonth}-05`,
        },
        {
          id: 2,
          title: "할일2",
          done: true,
          date: `${params.baseMonth}-06`,
        },
        {
          id: 3,
          title: "할일3",
