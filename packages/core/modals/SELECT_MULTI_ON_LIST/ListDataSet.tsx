...
import { useExampleService } from "@axboot/core/hooks/useExampleService";
import styled from "@emotion/styled";
import { Button, Form, Space } from "antd";
import { useBtnI18n, useContainerSize, useI18n } from "../../../../src/hooks";
import * as React from "react";
import { ExampleItem, ExampleListRequest } from "../../../../src/services";
...
interface Props {
  ...
  onChangeCheckedRow?: (rows: DtoItem[], checkedIndexes: number[], checkedRowKeys: React.Key[]) => void;
  checkedRowKeys?: React.Key[];
}

export function ListDataSet({ onClick, checkedRowKeys, onChangeCheckedRow }: Props) {
  const { t } = useI18n();
        ...
        <DataGrid<DtoItem>
          ...
          rowChecked={{
            ...
            onChange: (checkedIndexes, checkedRowKeys, checkedAll) => {
              ...
              const rows = checkedIndexes.map(idx => ds[idx].values);
