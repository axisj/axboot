...
import { alertDialog } from "@axboot/core/components/dialogs";
import styled from "@emotion/styled";
import { Input } from "antd";
import * as React from "react";
import { getI18n } from "../../../../src/hooks";

export function InputTimeEditor<T = Record<string, any>>({
  editable,
  value,
  handleSave,
  handleCancel,
  ...
  const parseValue = React.useCallback(value => {
    ...
    alertDialog({
      content: t("msg.inputTimeValidation"),
    });
