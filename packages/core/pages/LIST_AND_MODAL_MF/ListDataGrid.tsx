...
function ListDataGrid({ onClick }: Props) {
  ...
  const listColWidths = use$LIST_AND_MODAL_MF$Store(s => s.listColWidths);
  const listData = use$LIST_AND_MODAL_MF$Store(s => s.listData);
  const listPage = use$LIST_AND_MODAL_MF$Store(s => s.listPage);
  const listSpinning = use$LIST_AND_MODAL_MF$Store(s => s.listSpinning);
  const setListColWidths = use$LIST_AND_MODAL_MF$Store(s => s.setListColWidths);
  const changeListPage = use$LIST_AND_MODAL_MF$Store(s => s.changeListPage);
